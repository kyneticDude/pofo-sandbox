...
if ( ! defined( 'ABSPATH' ) ) { exit; }
    ...
    $pofo_product_archive_title_bg_image = pofo_category_title_option( 'pofo_product_archive_title_bg_image','' );
    ...
    $pofo_product_archive_title_parallax_effect = ( ! empty( $parallax_effect ) && $parallax_effect != 'no-parallax' ) ? ' data-parallax-background-ratio="'.$parallax_effect.'"': '';
                            ...
                            if( $pofo_breadcrumb_position == 'title-area' || $pofo_breadcrumb_position == '' ){
                                echo '<div class="col-lg-5 col-md-6 col-sm-12 col-xs-12 display-table text-right sm-text-center sm-margin-15px-top">';
                                    echo '<div class="display-table-cell vertical-align-middle breadcrumb text-small alt-font">';
                                        echo '<ul class="pofo-product-archive-title-breadcrumb">';
